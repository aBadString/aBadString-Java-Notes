...
- [1. Git](#1-git)
  ...
  - [1.5. 配置备份仓库](#15-配置备份仓库)
  - [1.6. GitLab](#16-gitlab)
- [2. Maven](#2-maven)
...
- [5. Ubuntu](#5-ubuntu)
  ...
  - [5.3. 安装 SSH](#53-安装-ssh)
    - [5.3.1. SSH 公钥登录](#531-ssh-公钥登录)
  - [5.4. 修改登录 Banner](#54-修改登录-banner)
  - [5.5. 固定IP地址](#55-固定ip地址)
    - [5.5.1. VMware 虚拟机三种网络模式](#551-vmware-虚拟机三种网络模式)
    - [5.5.2. 虚拟机桥接模式下固定静态 IP 地址](#552-虚拟机桥接模式下固定静态-ip-地址)
    - [5.5.3. 虚拟机 NAT 模式下固定静态 IP 地址](#553-虚拟机-nat-模式下固定静态-ip-地址)
      - [5.5.3.1. 解决虚拟机无法连接注解和外部网络的问题](#5531-解决虚拟机无法连接注解和外部网络的问题)
    - [5.5.4. nmap](#554-nmap)
  - [5.6. 文件上传](#56-文件上传)
  - [5.7. 常见问题](#57-常见问题)
- [6. CMD](#6-cmd)
  - [6.1. 批处理清理VS工程目录（递归删除Debug, Release, ipch目录及*.sdf文件）](#61-批处理清理vs工程目录递归删除debug-release-ipch目录及sdf文件)
- [7. Markdown](#7-markdown)
- [8. LaTeX](#8-latex)
  - [8.1. TeX Live + VS Code 搭建环境](#81-tex-live-vs-code-搭建环境)
  - [8.2. Hello, LaTeX](#82-hello-latex)
  - [8.3. 文章元信息](#83-文章元信息)
  - [8.4. 章节与段落](#84-章节与段落)
    - [8.4.1. 换行](#841-换行)
  - [8.5. 目录](#85-目录)
  ...
  - [8.8. 浮动体](#88-浮动体)
  - [8.9. 数学公式](#89-数学公式)
- [9. 基于项目的文件夹分类与命名规范](#9-基于项目的文件夹分类与命名规范)
- [10. 正则表达式](#10-正则表达式)
  - [10.1. 限定符](#101-限定符)
  - [10.2. 或运算符](#102-或运算符)
  - [10.3. 字符集合](#103-字符集合)
...
## 6.1. 批处理清理VS工程目录（递归删除Debug, Release, ipch目录及*.sdf文件）
```bat
@echo off
