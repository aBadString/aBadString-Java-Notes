...
- [2. React](#2-react)
  - [2.1. React 基础：面向组件编程](#21-react-基础面向组件编程)
  ...
  - [2.2. React Ajax (使用 axios)](#22-react-ajax-使用-axios)
  ...
  - [2.3. PubSubJS 消息发布订阅](#23-pubsubjs-消息发布订阅)
  - [2.4. React Router 与 SPA](#24-react-router-与-spa)
    - [2.4.1. SPA 单页面多组件](#241-spa-单页面多组件)
    - [2.4.2. 基本路由组件](#242-基本路由组件)
    - [2.4.3. Link 与 NavLink](#243-link-与-navlink)
    - [2.4.4. 路由匹配规则（Switch、Route 的 exact 属性、Redirect）](#244-路由匹配规则switch-route-的-exact-属性-redirect)
    - [2.4.5. 路由组件与一般组件（history 对象、withRouter 函数）](#245-路由组件与一般组件history-对象-withrouter-函数)
    - [2.4.6. 向路由组件传递参数](#246-向路由组件传递参数)
    - [2.4.7. 两种 Router：BrowserRouter、HashRouter](#247-两种-routerbrowserrouter-hashrouter)
...
### 2.4.4. 路由匹配规则（Switch、Route 的 exact 属性、Redirect）
...
### 2.4.5. 路由组件与一般组件（history 对象、withRouter 函数）
...
### 2.4.7. 两种 Router：BrowserRouter、HashRouter
