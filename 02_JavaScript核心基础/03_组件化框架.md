...
- [2. React](#2-react)
  - [2.1. Hello React](#21-hello-react)
  - [2.2. JSX 语法](#22-jsx-语法)
    - [2.2.1. 什么是 JSX?](#221-什么是-jsx)
    - [2.2.2. JSX 中嵌入表达式](#222-jsx-中嵌入表达式)
    - [2.2.3. JSX 本质](#223-jsx-本质)
    - [2.2.4. JSX 语法规则](#224-jsx-语法规则)
  - [2.3. 元素（虚拟 DOM）渲染](#23-元素虚拟-dom渲染)
    - [2.3.1. 虚拟 DOM 与 DOM diff 算法](#231-虚拟-dom-与-dom-diff-算法)
    - [2.3.2. 计时器的例子](#232-计时器的例子)
  - [2.4. 组件及其三大属性](#24-组件及其三大属性)
    - [2.4.1. 创建组件的两种方式](#241-创建组件的两种方式)
    - [2.4.2. 组件的3大属性: 组件参数 props](#242-组件的3大属性-组件参数-props)
    - [2.4.3. 组件的3大属性: 组件状态 state](#243-组件的3大属性-组件状态-state)
    - [2.4.4. 组件的3大属性: refs](#244-组件的3大属性-refs)
  - [2.5. 组件的生命周期](#25-组件的生命周期)
  - [2.6. 事件处理](#26-事件处理)
  - [2.7. 条件渲染](#27-条件渲染)
  - [2.8. 列表](#28-列表)
    - [2.8.1. key 的作用与效率问题](#281-key-的作用与效率问题)
  - [2.9. 表单](#29-表单)
    - [2.9.1. 非受控组件](#291-非受控组件)
    - [2.9.2. 受控组件](#292-受控组件)
  - [2.10. 创建 React 应用（create-react-app）](#210-创建-react-应用create-react-app)
  - [2.11. UmiJS](#211-umijs)
    - [2.11.1. 创建项目](#2111-创建项目)
    - [2.11.2. umi-plugin-react 插件](#2112-umi-plugin-react-插件)
  - [2.12. DvaJS](#212-dvajs)
  - [2.13. Ant Design](#213-ant-design)
- [3. Vue](#3-vue)
...
## 2.10. 创建 React 应用（create-react-app）
...
可以看出这个开发和部署过程很不**软件工程**，所以接下来我们使用 create-react-app 脚手架来创建和发布 React 应用。
