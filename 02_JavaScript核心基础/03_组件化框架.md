...
- [2. React](#2-react)
  ...
  - [2.4. 组件及其三大属性](#24-组件及其三大属性)
    ...
    - [2.4.5. 组件的生命周期](#245-组件的生命周期)
  - [2.5. 事件处理](#25-事件处理)
  - [2.6. 条件渲染](#26-条件渲染)
  - [2.7. 列表](#27-列表)
  - [2.8. 创建 React 应用（create-react-app）](#28-创建-react-应用create-react-app)
  - [2.9. UmiJS](#29-umijs)
    - [2.9.1. 创建项目](#291-创建项目)
    - [2.9.2. umi-plugin-react 插件](#292-umi-plugin-react-插件)
  - [2.10. DvaJS](#210-dvajs)
  - [2.11. Ant Design](#211-ant-design)
- [3. Vue](#3-vue)
...
- 第一次初始化显示: ReactDOM.render(<Xxx />, containDom)
  1. constructor() : 构造器
  1. componentWillMount() : 将要插入回调
  1. render() : 用于插入虚拟DOM回调
  1. componentDidMount() : 已经插入回调
...
## 2.8. 创建 React 应用（create-react-app）
