<!-- TOC -->autoauto- [1 MySQL 体系结构](#1-mysql-体系结构)auto    - [1.1 Innodb存储引擎缓冲池](#11-innodb存储引擎缓冲池)auto- [2 锁](#2-锁)auto    - [2.1 InnoDB 存储引擎中的锁](#21-innodb-存储引擎中的锁)auto    - [2.2 锁的算法](#22-锁的算法)auto    - [2.3 锁问题](#23-锁问题)auto    - [2.4 阻塞](#24-阻塞)auto    - [2.5 死锁](#25-死锁)auto    - [2.6 锁升级](#26-锁升级)auto- [3 事务](#3-事务)auto- [4 索引](#4-索引)auto    - [4.1 InnoDB 存储引擎支持的常见索引](#41-innodb-存储引擎支持的常见索引)auto    - [4.2 B+ 树](#42-b-树)auto        - [4.2.1 B+ 树](#421-b-树)auto    - [4.3 B+ 树索引](#43-b-树索引)auto        - [4.3.1 聚集索引](#431-聚集索引)auto        - [4.3.2 辅助索引 (非聚集索引)](#432-辅助索引-非聚集索引)auto        - [4.3.3 联合索引](#433-联合索引)auto- [5 数据库基础和SQL语言](#5-数据库基础和sql语言)auto    - [5.1 Show 命令](#51-show-命令)auto    - [5.2 检索数据](#52-检索数据)auto    - [5.3 过滤数据](#53-过滤数据)auto- [6 其他](#6-其他)autoauto<!-- /TOC -->
